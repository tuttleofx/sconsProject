...
see: http://www.scons.org/wiki/CudaTool
...
def generate(env):
		...
		env.SetDefault(
				...
				STATICNVCCCMD = '$NVCC -o $TARGET -c $NVCCFLAGS $STATICNVCCFLAGS $_CPPINCFLAGS $SOURCES',
				SHAREDNVCCCMD = '$NVCC -o $TARGET -c $NVCCFLAGS $SHAREDNVCCFLAGS $_CPPINCFLAGS $ENABLESHAREDNVCCFLAG $SOURCES',
			)
